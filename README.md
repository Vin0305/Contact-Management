A web application built using the MERN stack (MongoDB, Express, React, Node.js) for managing contacts with features like adding, viewing, editing, and deleting contacts
